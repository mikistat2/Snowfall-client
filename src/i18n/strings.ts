...
const en = {
  ...
  'auth.loginSubtitle': 'Sign in to your gym',
  'auth.registerSubtitle': 'A few details and your gym is set up',
  'auth.sectionGym': 'Your gym',
  'auth.sectionOwner': 'Your account',
  'auth.sectionPlan': 'Choose your package',
  'auth.planHint': 'You can change this later — nothing is charged today.',
  'auth.perMonth': '/month',
  'auth.setupFee': 'one-off setup',
  'auth.includesTelegram': 'Telegram bot',
  'auth.includesCamera': 'Face recognition',
  'auth.cameraAfterSetup': 'Face recognition switches on after payment and on-site setup.',
  'auth.showPassword': 'Show password',
  'auth.hidePassword': 'Hide password',
  'auth.brandLine1': 'Members, payments and check-ins in one place.',
  'auth.brandLine2': 'Telegram reminders that chase renewals for you.',
  'auth.brandLine3': 'Face recognition at the door, when you are ready for it.',
