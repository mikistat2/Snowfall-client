...
const en = {
  ...
  'auth.perMonth': '/month',
  'auth.perYear': '/year',
  'auth.billMonthly': 'Monthly',
  'auth.billYearly': 'Yearly',
  'auth.yearlySave': 'save {n}%',
  ...
  /** Reads as "<name> · starts ጳጉሜን 2 2018" in the enrolment toast. */
  'members.startsOn': 'starts',
  ...
  'payments.last30': 'Last 30 days',
  'payments.allTime': 'All payments',
  'payments.customRange': 'Selected dates',
  'settings.paymentsView': 'Payments view',
  'settings.paymentsViewHint': 'Which period the Payments page opens on. Applies to this device.',
  // correcting a payment (owner only)
  'payments.correct': 'Correct payment',
  'payments.fixDetails': 'Fix the details',
  'payments.removeEntirely': 'Remove it entirely',
  'payments.reason': 'Reason for the correction',
  'payments.reasonHint': 'e.g. typed 23002300 instead of 2300',
  'payments.needReason': 'Give a reason — it is kept with the record',
  'payments.keepsRecord':
    'The original stays in the ledger, struck through, with your name and reason, and stops counting towards revenue.',
  'payments.expiryUnchanged': "The member's expiry date is not affected.",
  'payments.saveCorrection': 'Save correction',
  'payments.removePayment': 'Remove payment',
  'payments.voided': 'Voided',
  'payments.correction': 'Correction',
  'payments.voidedBy': 'Voided by',
  // typo guard on the amount (see lib/payments.overpayNeedsConfirming)
  'payments.checkAmount': 'Is that amount right?',
  'payments.planPrice': 'Plan price',
  'payments.overBy': 'more',
  'payments.checkAmountBody': 'That is well above what this plan costs — check for a typo.',
  'payments.amountIsCorrect': 'Yes, that amount is correct',
  ...
  'enroll.startDate': 'Membership starts',
  'prev.capturesHint':
...
const am: Partial<Record<StringKey, string>> = {
  ...
  'payments.last30': 'ያለፉት 30 ቀናት',
  'payments.allTime': 'ሁሉም ክፍያዎች',
  'payments.customRange': 'የተመረጡ ቀናት',
  'settings.paymentsView': 'የክፍያ እይታ',
  'settings.paymentsViewHint': 'የክፍያዎች ገጽ በየትኛው ጊዜ እንደሚከፈት። በዚህ መሣሪያ ላይ ብቻ ይሠራል።',
  'payments.correct': 'ክፍያ አስተካክል',
  'payments.fixDetails': 'ዝርዝሩን አስተካክል',
  'payments.removeEntirely': 'ሙሉ በሙሉ አስወግድ',
  'payments.reason': 'የማስተካከያ ምክንያት',
  'payments.reasonHint': 'ለምሳሌ፦ 2300 ሲባል 23002300 ተጽፏል',
  'payments.needReason': 'ምክንያት ያስገቡ — ከመዝገቡ ጋር ይቀመጣል',
  'payments.keepsRecord':
    'የመጀመሪያው መዝገብ በሰረዝ ምልክት ተደርጎ፣ በስምዎና በምክንያቱ ተመዝግቦ ይቆያል፤ በገቢ ስሌት ውስጥ አይካተትም።',
  'payments.expiryUnchanged': 'የአባሉ የማብቂያ ቀን አይቀየርም።',
  'payments.saveCorrection': 'ማስተካከያውን አስቀምጥ',
  'payments.removePayment': 'ክፍያውን አስወግድ',
  'payments.voided': 'የተሰረዘ',
  'payments.correction': 'ማስተካከያ',
  'payments.voidedBy': 'የሰረዘው',
  'payments.checkAmount': 'መጠኑ ትክክል ነው?',
  'payments.planPrice': 'የዕቅዱ ዋጋ',
  'payments.overBy': 'በላይ',
  'payments.checkAmountBody': 'ይህ ከዕቅዱ ዋጋ በጣም ይበልጣል — የጽሕፈት ስህተት አለመኖሩን ያረጋግጡ።',
  'payments.amountIsCorrect': 'አዎ፣ መጠኑ ትክክል ነው',
...
const om: Partial<Record<StringKey, string>> = {
  ...
  'enroll.startDate': 'Miseensummaan kan jalqabu',
  ...
  'payments.last30': 'Guyyoota 30 darban',
  'payments.allTime': 'Kaffaltii hunda',
  'payments.customRange': 'Guyyoota filataman',
  'settings.paymentsView': 'Mulʼannoo kaffaltii',
  'settings.paymentsViewHint': 'Fuulli kaffaltii yeroo kamiin akka banamu. Meeshaa kana irratti qofa hojjeta.',
  'payments.correct': 'Kaffaltii sirreessi',
  'payments.fixDetails': 'Ragaa sirreessi',
  'payments.removeEntirely': 'Guutummaatti haqi',
  'payments.reason': 'Sababa sirreeffamaa',
  'payments.reasonHint': 'fkn. 2300 osoo taʼu 23002300 barreeffame',
  'payments.needReason': 'Sababa galchi — galmee waliin ni turteera',
  'payments.keepsRecord':
    'Galmeen jalqabaa sarara irratti mullata; maqaa kee fi sababa waliin ni turteera, galii keessattis hin lakkaaʼamu.',
  'payments.expiryUnchanged': 'Guyyaan xumura miseensaa hin jijjiiramu.',
  'payments.saveCorrection': 'Sirreeffama olkaaʼi',
  'payments.removePayment': 'Kaffaltii haqi',
  'payments.voided': 'Haqame',
  'payments.correction': 'Sirreeffama',
  'payments.voidedBy': 'Kan haqe',
  'payments.checkAmount': 'Baayʼinni kun sirriidhaa?',
  'payments.planPrice': 'Gatii karoora',
  'payments.overBy': 'caalaa',
  'payments.checkAmountBody': 'Kun gatii karoora kanaa caalaa baayʼeedha — dogoggora barreeffamaa ilaali.',
  'payments.amountIsCorrect': 'Eeyyee, baayʼinni kun sirriidha',
